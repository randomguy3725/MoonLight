...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void setWindowIcon()
    {
        ...
        {
            try (
                    var inputstream = this.mcDefaultResourcePack.getInputStreamAssets(new ResourceLocation("icons/icon_16x16.png"));
                    var inputstream1 = this.mcDefaultResourcePack.getInputStreamAssets(new ResourceLocation("icons/icon_32x32.png"));
            ) {
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException
    {
        ...
        try (var inputstream = this.mcDefaultResourcePack.getInputStream(locationMojangPng))
        {
